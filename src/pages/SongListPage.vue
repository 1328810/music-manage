<template>
  <div class="table">
    ...
    <!-- 添加歌单 -->
    <el-dialog title="添加歌单" :visible.sync="centerDialogVisible" width="450px" center>
    ...
    <!--修改歌单  -->
    <el-dialog title="修改歌单" :visible.sync="editVisible" width="450px" center>
    ...
    <!-- 删除歌单 -->
    <el-dialog title="修改歌单" :visible.sync="delVisible" width="300px" center>
    ...
    addSongList() {
      this.$refs['registerForm'].validate(valid => {
        if (valid) {
          ...
          params.append("pic", "/img/songListPic/1.jpeg");
