<template>
  <div class="table">
    ...
    <el-table size="mini" ref="multipleTTable" border style="width: 100%" height="680px" :data="data"
      ...
      <el-table-column prop="introduction" label="签名" width="100" align="center"></el-table-column>
    ...
    <!-- 添加用户 -->
    <el-dialog title="添加新用户" :visible.sync="centerDialogVisible" width="450px" center>
    ...
    <!--修改用户  -->
    <el-dialog title="修改用户" :visible.sync="editVisible" width="450px" center>
    ...
    <!-- 删除用户 -->
    <el-dialog title="修改用户" :visible.sync="delVisible" width="300px" center>
