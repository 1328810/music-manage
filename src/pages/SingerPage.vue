<template>
  <div class="table">
    ...
    <!-- 添加歌手 -->
    <el-dialog title="添加歌手" :visible.sync="centerDialogVisible" width="450px" center>
    ...
    <!--修改歌手  -->
    <el-dialog title="修改歌手" :visible.sync="editVisible" width="450px" center>
...
export default {
  ...
  methods: {
    ...
    getData() {
      this.tempData = [];
      this.tableData = [];
      getAllSinger(this.songListId).then((res) => {
        this.tempData = res;
        this.tableData = res;
        this.currentPage = 1;
      });
    ...
    addSinger() {
      this.$refs['registerForm'].validate(valid => {
        if (valid) {
          ...
          params.append("pic", "/img/singerPic/002.jpeg");
